      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="space-y-2">
              <Label>Verification Documents (PDF only)</Label>
                  ...
                  {existingDocuments.map((doc, index) => (
                    <div key={index} className="relative group">
                      <a
                        ...
                        className="w-full h-32 flex items-center justify-center bg-muted rounded-lg border cursor-pointer hover:bg-muted/80 transition-colors"
                      >
                        <div className="text-center">
                          <svg className="h-12 w-12 mx-auto text-red-500" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z" />
                          </svg>
                          <p className="text-xs mt-1">PDF Document {index + 1}</p>
                        </div>
                      </a>
                      <Button
                        type="button"
